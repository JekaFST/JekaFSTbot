...
helptext = '/start - для начала работы с ботом. Команда создает сессию для чата' \
           'Коды сдавать в виде !код или ! код или .код или . код\n' \
           ...
           '/ll s3600 - отправить live locations из уровня\n' \
           ...
           '/ll s3600 корды, где s3600 - длительность в секундах\n' \
           'если длительность не задана - по умолчанию - 3 часа\n' \
           ...
           '/addll - отправить live locations из чата. Формат:\n' \
           '/addll s3600\n' \
           '1 - корды\n2 - корды\n...\nn - корды\n' \
           'где s3600 - длительность в секундах\n' \
           'если длительность не задана - по умолчанию - 3 часа\n\n' \
           'При <b>штурмовой</b> игре поддерживается сдача кодов:\n' \
