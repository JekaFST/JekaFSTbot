...
#             bot.send_message(chat_id, 'Данный чат не является разрешенным для работы с ботом')
#             return False
...
#     }
#     main_thread.task_queue.append(start_task)
...
#     return flask.jsonify(session.current_level)
    ...
    def start_flask(self):
        self.run_app(self.bot).run(host='0.0.0.0', port=443, debug=False)
